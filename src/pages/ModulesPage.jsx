        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-16">
          ...
          >
            ...
            <p className="mt-4 max-w-2xl text-sm sm:text-base font-light leading-relaxed text-slateink/65">
              ...
              <br /><br />
              ประติมากรรม IMPACT RE:BUILD ถูกรังสรรค์ขึ้นจากระบบโมดูลย่อย 17 ยูนิตโครงสร้างที่เชื่อมต่อกันด้วยระบบวิศวกรรมแบบถอดประกอบซ้ำได้ (Re-configurable Dynamic System) เอื้อต่อการปรับเปลี่ยนผังรูปทรงให้เข้ากับบริบทพื้นที่จัดแสดงสินค้าและการประชุมของอิมแพ็ค เมืองทองธานีได้อย่างไร้ขีดจำกัด อีกทั้งยังมีระบบ QR Code ประจำแต่ละโมดูล เพื่อให้ผู้ร่วมงานและทีมงานสแกนตรวจสอบรายการวัสดุและชิ้นส่วน (BOM) ได้อย่างแม่นยำและโปร่งใส
            </p>
          </motion.div>
        </div>
      </section>
