...
export const mockModules = [
  ...
  },
  {
    ...
    code: 'D2',
    title: 'MODULE D2',
    title_th: 'โมดูลฐานทรงเตี้ย D2',
    category: 'Compact Cube',
    category_th: 'Compact (55cm)',
    desc: 'โมดูลขนาดสัดส่วนพิเศษ โครงโลหะ 55cm ผสาน 30cm สำหรับจัดวางระนาบเตี้ยและกระจายฐานรองรับ',
    specs: ['โลหะ 55cm x 8 เส้น', 'โลหะ 30cm x 4 เส้น', 'แผ่นพลาสติก rHDPE 1 แผ่น'],
    components: [
      { name: 'Metal 55cm', qty: 8, unit: 'line', category: 'metal' },
      { name: 'Metal 30cm', qty: 4, unit: 'line', category: 'metal' },
  ...
  },
  {
    ...
    code: 'D3',
    title: 'MODULE D3',
    title_th: 'โมดูลฐานทรงเตี้ย D3',
    category: 'Compact Cube',
    category_th: 'Compact (55cm)',
    desc: 'โมดูลขนาดสัดส่วนพิเศษ โครงโลหะ 55cm ผสาน 30cm สำหรับเชื่อมระดับความสูง',
    specs: ['โลหะ 55cm x 8 เส้น', 'โลหะ 30cm x 4 เส้น', 'แผ่นพลาสติก rHDPE 1 แผ่น'],
    components: [
      { name: 'Metal 55cm', qty: 8, unit: 'line', category: 'metal' },
      { name: 'Metal 30cm', qty: 4, unit: 'line', category: 'metal' },
  ...
  },
  {
    ...
    code: 'D4',
    title: 'MODULE D4',
    title_th: 'โมดูลฐานทรงเตี้ย D4',
    category: 'Compact Cube',
    category_th: 'Compact (55cm)',
    desc: 'โมดูลขนาดสัดส่วนพิเศษ โครงโลหะ 55cm ผสาน 30cm เพื่อความสมดุลของประติมากรรม',
    specs: ['โลหะ 55cm x 8 เส้น', 'โลหะ 30cm x 4 เส้น', 'แผ่นพลาสติก rHDPE 1 แผ่น'],
    components: [
      { name: 'Metal 55cm', qty: 8, unit: 'line', category: 'metal' },
      { name: 'Metal 30cm', qty: 4, unit: 'line', category: 'metal' },
  ...
  },
  {
    ...
    code: 'Plants',
    title: 'MODULE Plants',
    title_th: 'โมดูลต้นไม้ประดิษฐ์ตกแต่ง (6 จุด)',
    category: 'พืชพันธุ์ & แสงไฟ',
    category_th: 'พืชพันธุ์ & แสงไฟ',
    desc: 'ชุดกระถางต้นไม้ประดิษฐ์ (ต้นไม้ปลอม) 6 ยูนิต เสริมความสดชื่นสไตล์ Biophilic Design ดูแลง่าย ไม่ต้องรดน้ำ ทนทานตลอดการจัดแสดง และนำกลับมาใช้ซ้ำ (Reusable) ได้ทุกงานอีเวนต์',
    specs: ['ต้นไม้ประดิษฐ์ (ต้นไม้ปลอม) 6 จุด', 'Zero Maintenance ไม่ต้องรดน้ำ', 'นำกลับมาใช้ซ้ำได้ทุกงาน (Reusable)'],
    components: [
      { name: 'ต้นไม้ประดิษฐ์ (Artificial Plants)', qty: 6, unit: 'units', category: 'nature' },
    ],
    accent: '#10B981',
    tone: 'cyan',
    images: [],
